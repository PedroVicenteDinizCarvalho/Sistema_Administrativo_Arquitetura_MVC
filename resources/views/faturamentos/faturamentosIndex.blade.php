	...
	<div class="col-md-12 row">
		...
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
			...
			<nav class="nav nav-pills flex-column flex-sm-row">
  				<a class="flex-sm-fill text-sm-center nav-link" href="{{ url('home/faturamentos/analise') }}">Análises</a>
  				<a class="flex-sm-fill text-sm-center nav-link" href="{{ url('home/faturamentos/historico') }}">Histórico</a>
